...
export LoadConfig_fft
export _LoadConfig_fft
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_fft_Ordered
	lcall	LoadConfig_fft

    RAM_EPILOGUE RAM_USE_CLASS_4
    ret

;---------------------------------------------------------------------------
; Load Configuration fft
;
;    Load configuration registers for fft.
...
_LoadConfig_fft:
 LoadConfig_fft:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_fft_Bank0
    mov     X, <LoadConfigTBL_fft_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_fft_Bank1
    mov     X, <LoadConfigTBL_fft_Bank1
