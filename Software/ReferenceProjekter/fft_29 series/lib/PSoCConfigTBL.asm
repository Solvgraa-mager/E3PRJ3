...
export LoadConfigTBL_fft_Bank1
export LoadConfigTBL_fft_Bank0
export LoadConfigTBL_fft_Ordered
AREA lit(rom, rel)
LoadConfigTBL_fft_Ordered:
...
;  Global Register values
	...
	db		e6h, 03h		; DecimatorControl_0 register (DEC_CR0)
	...
	db		cah, 00h		; Row_3_LogicInputAMux register (RDI3IS)
...
;       Instance name DELSIG11_1, Block Name ADC(ASD11)
	db		84h, 90h		;DELSIG11_1_AtoDcr0(ASD11CR0)
	db		85h, 00h		;DELSIG11_1_AtoDcr1(ASD11CR1)
	db		86h, 60h		;DELSIG11_1_AtoDcr2(ASD11CR2)
	db		87h, f0h		;DELSIG11_1_AtoDcr3(ASD11CR3)
;       Instance name DELSIG11_1, Block Name TMR(DBB10)
	db		33h, 00h		;DELSIG11_1_TimerCR0(DBB10CR0)
	db		31h, 00h		;DELSIG11_1_TimerDR1(DBB10DR1)
	db		32h, 00h		;DELSIG11_1_TimerDR2(DBB10DR2)
;  Instance name LCD_1, User Module LCD
;  Instance name PGA_1, User Module PGA
;       Instance name PGA_1, Block Name GAIN(ACB01)
	db		75h, fdh		;PGA_1_GAIN_CR0(ACB01CR0)
...
;  Global Register values
	...
	db		e1h, 28h		; OscillatorControl_1 register (OSC_CR1)
...
;       Instance name DELSIG11_1, Block Name ADC(ASD11)
;       Instance name DELSIG11_1, Block Name TMR(DBB10)
	db		30h, 20h		;DELSIG11_1_TimerFN(DBB10FN)
	db		31h, 15h		;DELSIG11_1_TimerSL(DBB10IN)
	db		32h, 40h		;DELSIG11_1_TimerOS(DBB10OU)
;  Instance name LCD_1, User Module LCD
;  Instance name PGA_1, User Module PGA
;       Instance name PGA_1, Block Name GAIN(ACB01)
;  Instance name UART_1, User Module UART
...
;       Instance name UART_1, Block Name TX(DCB02)
	...
	db		2ah, 07h		;UART_1_TX_OUTPUT_REG (DCB02OU)
	db		ffh
