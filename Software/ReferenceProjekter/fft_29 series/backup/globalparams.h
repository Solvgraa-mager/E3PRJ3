...
#define POWER_SETTING          0x@Power Setting [ Vcc / IMO freq ] //Power Setting [ Vcc / IMO freq ] 0x10 = 5.0V / 24MHz
										//				0x08 = 3.3V / 24MHz
										//				0x09 = 3.3V / 12MHz
...
#define CLOCK_DIV_VC2          0x8     // VC2 clock divider 
#define CLOCK_DIV_VC2_MASK     0xf     // VC2 clock divider mask
#define CLOCK_DIV_VC2_JUST     0x8     // VC2 clock divider justified
