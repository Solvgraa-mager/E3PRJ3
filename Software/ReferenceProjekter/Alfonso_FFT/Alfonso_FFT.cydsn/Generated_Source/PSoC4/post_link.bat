...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\asha\Documents\PSoC3 training and projects\Q2-13\Alfonso_FFT\Alfonso_FFT.cydsn\Alfonso_FFT.svd" rem "C:\Users\asha\Documents\PSoC3 training and projects\Q2-13\Alfonso_FFT\Alfonso_FFT.cydsn\Alfonso_FFT.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
