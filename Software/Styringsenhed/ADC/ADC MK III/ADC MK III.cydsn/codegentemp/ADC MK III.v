...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("220a0222-c10c-44cc-8e74-584023227521/b7604721-db56-4477-98c2-8fae77869066"),
...
module SPI_Slave_v2_70_3 (
	...
	cy_clock_v1_0
		#(.id("a7b45dc3-8beb-4f80-89c4-c806bb4d36a3/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Floejtelyd_net;
	wire [0:0] tmpFB_0__Floejtelyd_net;
	wire [0:0] tmpIO_0__Floejtelyd_net;
	wire [0:0] tmpINTERRUPT_0__Floejtelyd_net;
	electrical [0:0] tmpSIOVREF__Floejtelyd_net;
	...
	assign tmpOE__Floejtelyd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Proc_done_test_net;
	wire [0:0] tmpFB_0__Proc_done_test_net;
	wire [0:0] tmpIO_0__Proc_done_test_net;
	wire [0:0] tmpINTERRUPT_0__Proc_done_test_net;
	electrical [0:0] tmpSIOVREF__Proc_done_test_net;

	cy_psoc3_pins_v1_10
		#(.id("1305c1b2-d2ac-443b-9c91-f34cb722064f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Proc_done_test
		 (.oe(tmpOE__Proc_done_test_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Proc_done_test_net[0:0]}),
		  .io({tmpIO_0__Proc_done_test_net[0:0]}),
		  .siovref(tmpSIOVREF__Proc_done_test_net),
		  .interrupt({tmpINTERRUPT_0__Proc_done_test_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Proc_done_test_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ADC_EOC_net;
	wire [0:0] tmpFB_0__ADC_EOC_net;
	wire [0:0] tmpIO_0__ADC_EOC_net;
	wire [0:0] tmpINTERRUPT_0__ADC_EOC_net;
	electrical [0:0] tmpSIOVREF__ADC_EOC_net;

	cy_psoc3_pins_v1_10
		#(.id("6bb974fa-eaf5-4425-baa2-d7656c7274b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_EOC
		 (.oe(tmpOE__ADC_EOC_net),
		  .y({Net_62}),
		  .fb({tmpFB_0__ADC_EOC_net[0:0]}),
		  .io({tmpIO_0__ADC_EOC_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_EOC_net),
		  .interrupt({tmpINTERRUPT_0__ADC_EOC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpFB_0__MISO_PIN_net;
	...
	wire [0:0] tmpOE__MOSI_PIN_net;
	wire [0:0] tmpIO_0__MOSI_PIN_net;
	wire [0:0] tmpINTERRUPT_0__MOSI_PIN_net;
	electrical [0:0] tmpSIOVREF__MOSI_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		MOSI_PIN
		 (.oe(tmpOE__MOSI_PIN_net),
		  .y({1'b0}),
		  .fb({Net_91}),
		  .io({tmpIO_0__MOSI_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI_PIN_net),
		  .interrupt({tmpINTERRUPT_0__MOSI_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1a89366d-9860-4dc6-94c7-5229db99614d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8c90924a-773f-4eea-a8ba-2e57c6b6d362"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
