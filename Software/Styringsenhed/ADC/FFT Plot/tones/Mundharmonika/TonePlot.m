clear; clc; 
N = 512 %%% HER PLOTTES: 128 256 og 512
...
axis tight
printTarget = gcf;
saveas(printTarget, ['figs/NoHannTimePlot_N_' num2str(N)], 'epsc')
saveas(printTarget, ['figs/preview/NoHannTimePlot_N_' num2str(N)], 'png')
...
% printTarget = gcf;
% saveas(printTarget, ['figs/NoHannFFT_N_' num2str(N)], 'epsc')
% saveas(printTarget, ['figs/preview/NoHannFFT_N_' num2str(N)], 'png')
...
printTarget = gcf;
saveas(printTarget, ['figs/NoHannFFT_Close_N_' num2str(N)], 'epsc')
saveas(printTarget, ['figs/preview/NoHannFFT_Close_N_' num2str(N)], 'png')
...
hold off
printTarget = gcf;
saveas(printTarget, ['figs/NoHannFFT_Bar_N_' num2str(N), '_Bins_', num2str(N / 2)], 'epsc')
saveas(printTarget, ['figs/preview/NoHannFFT_Bar_N_' num2str(N), '_Bins_', num2str(N / 2)], 'png')
% legend('Tone 1','Tone 2','Tone 3','Tone 4','location','northwest');
