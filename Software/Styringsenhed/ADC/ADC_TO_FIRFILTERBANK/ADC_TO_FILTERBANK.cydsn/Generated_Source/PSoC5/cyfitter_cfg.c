...
#define BS_PHUB_CFGMEM10_VAL ((const uint8 CYFAR *)0x480000A0u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AMUX, 0x20u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x01010105u);
